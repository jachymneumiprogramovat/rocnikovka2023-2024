...
Jak bude popsáno v
\myref{podsekci}{ssec:treni-odraz}, na míček v průběhu kontaktu působí
...
koeficient restituce. Definice z \myref{rovnice}{eq:CORR} není dostatečná
...
případě tato osa prochází středem míčku a v \myref{obrázku}{fig:odraz-micku} si ji
...
%rád bych napsal apendix o tom jak integrovat v kouli jakoukoliv funkci
%hustoty a podle toho získal koeficient momentu hybnosti.
...
jakém případě ovlivňuje moment hybnosti, přímočaré. Z \myref{obrázku}{fig:odraz-micku} je
...
\subsubsection{Žádný spin}
\label{sssec:adny-spin}

Jak už je možná čtenáři jasné z \myref{kapitoly}{sssec:smer-treni}, pro
